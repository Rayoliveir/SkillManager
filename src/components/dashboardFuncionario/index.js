            ...
            <div className="card-content">
                <div className="students-table">
                    <div className="table-header">
                        ...
                        <div className="table-cell">Instituição</div>
                    ...
                    <div className="table-row">
                        ...
                        <div className="table-cell">Universidade Tech</div>
                ...
                <div className="card-content">
                    ...
                    {selectedIntern ? (
                        <div className="evaluations-list">
                            ...
                            <div className="new-evaluation-form card">
                                ...
                                <form>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="rating-input">
                                            {[1, 2, 3, 4, 5].map((star) => (
                                                <span key={star} className="rating-star-input">★</span>
                                            ))}
                                        </div>
                                    </div>
        ...
        <main className="dashboard-main-content">
            <div className="dashboard-header">
                <div className="welcome-section">
                    <h1 className="dashboard-title">Bem-vindo, <span className="highlight">{dashboardData.dadosFuncionario.nome}</span></h1>
                    <p className="dashboard-subtitle">Aqui está o resumo das suas atividades</p>
                </div>
            ...
            <div className="conteudo-aba-container">
                {abaAtiva === 'informacoes' && <AbaInformacoes dadosFuncionario={dashboardData.dadosFuncionario} />}
