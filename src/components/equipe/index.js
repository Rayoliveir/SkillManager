                ...
                <section className="equipe-members" ref={containerRef}>
                    <div className="member-card">
                        <div className="member-photo">
                            <img src="/assets/images/marcelly.jpeg" alt="Membro da equipe" />
                        </div>
                    ...
                    <div className="member-card">
                        <div className="member-photo">
                            <img src="/assets/images/michel.jpg" alt="Membro da equipe" />
                        </div>
                        <div className="member-info">
                    ...
                    <div className="member-card">
                        <div className="member-photo">
                            <img src="/assets/images/natalia.jpeg" alt="Membro da equipe" />
                        </div>
                        <div className="member-info">
                    ...
                    <div className="member-card">
                        <div className="member-photo">
                            <img src="/assets/images/rhana.jpeg" alt="Membro da equipe" />
                        </div>
                        <div className="member-info">
                            <h3>Rhana Souza</h3>
                            <p className="role">Desenvolvedor</p>
                    ...
                    <div className="member-card">
                        <div className="member-photo">
                            <img src="/assets/images/tiago.jpeg" alt="Membro da equipe" />
                        </div>
                        <div className="member-info">
                            <h3>Tiago Santana</h3>
                            <p className="role">Desenvolvedor</p>
