...
import { Building, Users, Star, FileText, Edit, TrendingUp, Printer } from 'lucide-react'; 
...
// --- ATUALIZAÇÃO AQUI: RECEBE 'emailCoordenador' ---
            ...
            <div className="info-card">
                ...
                <div className="card-body">
                    <div className="info-details">
                        ...
                        {/* AQUI MOSTRAMOS O EMAIL DO COORDENADOR */}
                        ...
                        <div className="info-row"><span className="info-label">Endereço:</span><span className="info-value">{dadosFaculdade.endereco?.logradouro}, {dadosFaculdade.endereco?.numero} - {dadosFaculdade.endereco?.cidade}/{dadosFaculdade.endereco?.estados}</span></div>
                    </div>
                </div>
            </div>
        </div>
...
const ModalPerfil = ({ onClose, dadosIniciais, onUpdateSuccess }) => {
    // Atenção: dadosIniciais aqui é o objeto 'dashboardCoordenador' inteiro, 
    // então acessamos dadosIniciais.dadosCoordenador
    ...
    return (
        <div className="evaluation-form-overlay">
            ...
            <div className="evaluation-form-modal">
                <div className="form-header"><h3>Editar perfil (Coordenador)</h3><button className="close-btn" onClick={onClose}>×</button></div>
                <form onSubmit={handleSubmit} className="form-body">
                    ...
                    <div className="form-group"><label>Nova senha (opcional)</label><input className="form-input" name="senha" type="password" value={formData.senha} onChange={handleChange} placeholder="Deixe em branco para não alterar" /></div>
        ...
        <div className="dashboard-layout">
            ...
            <div className="dashboard-main">
                ...
                <div className="tab-content-container">
                    {/* AQUI PASSAMOS O EMAIL DO COORDENADOR PARA O COMPONENTE */}
                    {activeTab === 'informacoes' && 
                        <AbaInformacoes 
                            dadosFaculdade={dadosDashboard.dadosFaculdade} 
                            emailCoordenador={dadosDashboard.dadosCoordenador?.email}
