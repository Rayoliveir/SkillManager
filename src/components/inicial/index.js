...
import { User, BarChart3, Target, Award, Check } from 'lucide-react';
      ...
      <div className="cta-section">
        <div className="cta-content">
          ...
          <div className="cta-guarantee">
            <Check className="guarantee-icon" size={16} />
            <span className="guarantee-text">Comece gratuitamente</span>
          </div>
        </div>
      </div>
    </div>
