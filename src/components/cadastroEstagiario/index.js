...
function CadastroEstagiario() {
    ...
    const handleChange = (e) => {
        ...
        if (name === 'dadosAcademicos.faculdadeCnpj') value = maskCNPJ(value);
            ...
            content: (
                <>
                    <fieldset className="dados-pessoais">
                        ...
                        <label>Telefone <br />
                            <input type="tel" name="telefone" placeholder="(XX) XXXXX-XXXX" required value={formData.telefone} onChange={handleChange} maxLength="15" />
                        </label>
                        <label>CPF <br />
                            <input type="text" name="cpf" placeholder="000.000.000-00" required value={formData.cpf} onChange={handleChange} maxLength="14" />
                        </label>
                    </fieldset>
                </>
            )
            ...
            content: (
                <>
                    <fieldset className="dados-acesso">
                        ...
                        <label>Senha<br />
                            <input type="password" name="senha" placeholder="Min. 6 caracteres" minLength="6" required value={formData.senha} onChange={handleChange} />
                        </label>
                    </fieldset>
                </>
            )
            ...
            content: (
                <>
                    <fieldset className="dados-academicos">
                        ...
                        <label>CNPJ da instituição de ensino <br />
                            <input type="text" name="dadosAcademicos.faculdadeCnpj" placeholder="00.000.000/0001-00" required value={formData.dadosAcademicos.faculdadeCnpj} onChange={handleChange} maxLength="18" />
                        </label>
                        <label>Curso<br />
                        ...
                        <label>Período/Semestre<br />
                            <input type="text" name="dadosAcademicos.periodoSemestre" placeholder="Ex: 4" required value={formData.dadosAcademicos.periodoSemestre} onChange={handleChange} />
                        </label>
