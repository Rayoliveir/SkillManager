...
public class EstagiarioService {
    ...
    public EstagiarioService(EstagiarioRepository estagiarioRepository, FaculdadeRepository faculdadeRepository, PasswordEncoder passwordEncoder) {
    ...
    // O restante da classe com todos os métodos CRUD
    @Transactional
    ...
    private EstagiarioResponseDTO toResponseDTO(Estagiario estagiario) {
