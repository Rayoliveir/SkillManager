...
import com.senai.skillmanager.model.estagiario.DadosAcademicos; // Import Importante
...
import java.time.YearMonth; // Import Importante
...
public class EstagiarioService {
    ...
    private final FaculdadeRepository faculdadeRepository; // Nova injeção
    ...
    public EstagiarioService(EstagiarioRepository estagiarioRepository,
                             ...
                             FaculdadeRepository faculdadeRepository) { // Adicionado ao construtor
        ...
        this.faculdadeRepository = faculdadeRepository; // Inicializado
    }
    ...
    public EstagiarioResponseDTO salvar(EstagiarioDTO dto) {
        ...
        // Busca e define a Empresa pelo código
        ...
        // --- CORREÇÃO: Salva Dados Acadêmicos ---
        if (dto.getDadosAcademicos() != null) {
            ...
            // O CascadeType.ALL no Estagiario vai salvar isso automaticamente
