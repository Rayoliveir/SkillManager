                    ...
                    <div className="values">
                        ...
                        <div className="values-grid">
                            <div className="value-card">
                                <h3>Inovação</h3>
                                <p>Buscamos constantemente novas soluções para melhorar a experiência de gestão de estagiários.</p> </div> <div className="value-card">
                                <h3>Excelência</h3>
                                <p>Comprometidos com a qualidade em todos os aspectos do nosso trabalho.</p> </div> <div className="value-card">
                                <h3>Colaboração</h3>
                                <p>Acreditamos no poder do trabalho em equipe para alcançar resultados extraordinários.</p> </div> <div className="value-card">
                                <h3>Transparência</h3>
                                <p>Promovemos um ambiente aberto e honesto entre todos os envolvidos.</p>
                            </div>
                        </div>
                    </div>
                </section> {/* Added Equipe section here */} <section className="equipe-section"> <Equipe /> </section>
            </main> <Footer />
        </div>);
}
